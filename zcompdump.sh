...
autoload -Uz _SuSEconfig _a2ps _a2utils _aap _ack \
            _acpi _acpitool _acroread _adb _alias \
            ...
            _baz _be_name _beadm _bind_addresses _bindkey \
            ...
            _cdr _cdrdao _cdrecord _chflags _chkconfig \
            _chmod _chown _chrt _combination _comm \
            ...
            _cygstart _dak _darcs _date _dchroot \
            _dchroot-dsa _dcop _dd _deb_packages _debchange \
            _debdiff _debfoster _debsign _default _defaults \
            _delimiters _describe _description _devtodo _dhclient \
            ...
            _dmidecode _domains _dpatch-edit-patch _dpkg _dpkg-buildpackage \
            _dpkg-cross _dpkg-repack _dpkg_source _dput _dtrace \
            ...
            _file_systems _files _find _finger _fink \
            ...
            _mondo _monotone _mosh _most_recent_file _mount \
            _mozilla _mpc _mplayer _mt _mtools \
            _mtr _multi_parts _mutt _my_accounts _mysql_utils \
            _mysqldiff _nautilus _ncftp _nedit _net_interfaces \
            _netcat _netscape _netstat _newsgroups _next_label \
            ...
            _pkg-config _pkg5 _pkg_instance _pkgadd _pkginfo \
            _pkgrm _pkgtool _pon _portaudit _portlint \
            _portmaster _ports _portsnap _postfix _powerd \
            _prcs _precommand _prefix _print _printenv \
            _printers _procstat _prompt _prstat _ps \
            ...
            _retrieve_mac_apps _ri _rlogin _rm _rpm \
            ...
            _sqlite _sqsh _ssh _sshfs _stat \
            ...
            _svcs _svcs_fmri _svn-buildpackage _sysctl _systemd \
            _tags _tar _tar_archive _tardy _tcpdump \
            _tcpsys _tcptraceroute _telnet _terminals _tex \
            _texi _texinfo _tidy _tiff _tilde \
            _tilde_files _time_zone _tin _tla _tmux \
            _todo.sh _toilet _toolchain-source _topgit _totd \
            _tpb _tpconfig _tracepath _trap _tree \
            _ttyctl _tune2fs _twidge _twisted _typeset \
            _ulimit _uml _unace _uname _unexpand \
            _unhash _uniq _unison _units _unsetopt \
            _update-alternatives _update-rc.d _urls _urpmi _urxvt \
            _uscan _user_admin _user_at_host _user_expand _users \
